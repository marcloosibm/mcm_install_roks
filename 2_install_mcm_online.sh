...
then
  ...
  echo "    ${RED}ERROR${NC}: No default Storage Class defined. Aborting."
  exit 1
fi
...
kubectl get appsub --all-namespaces

kubectl get PlacementRule -n k8s-demo-app k8s-demo-app-web-placement -oyaml
